        ...
        <div className="kraft-section">
          <div className="vertical-align-wrap">
            <div className="vertical-align vertical-align--middle">
              <h2>it was 2010 when phil & katy first met through mutual friends - but their relationship didn’t truly begin until the summer of 2012. </h2>
            </div>
          </div>
        </div>
        <div className="container">
          <div className="picture-left">
            <img src={require('../images/hug.jpg')}/>
          </div>
          <div className="text-right">
            ...
            <p>One weekend on a whim, Katy decided to travel back home to Charlotte to see a show at local music venue, Snug Harbor. Phil was also there at random, and the two began catching up and quickly made plans to meet again. After their first date, they were inseperable.</p>
            <p>They maintained a long distance relationship until Katy graduated from ASU in the winter of 2013- when they decided to move in together. Having a shared passion for all things tech-related, Phil began teaching himself programming and front-end development, while Katy steered her career focus towards user experience and user interaction design.</p>
